...
def home(request):
    ...
    return render(request,'instagram/index.html',{"all_insta_images":all_insta_images})
...
def profile(request,username):
    ...
    return render (request,"instagram/profile.html",{"profile":profile,"all_images":all_images})
